...
| `recipients_sendgrid_1.csv` | 217 | 218 | `/home/jc/email-automation/recipients_sendgrid_1.csv` |
| `recipients_sendgrid_2.csv` | 217 | 218 | `/home/jc/email-automation/recipients_sendgrid_2.csv` |
| `recipients_sendgrid_3.csv` | 217 | 218 | `/home/jc/email-automation/recipients_sendgrid_3.csv` |
| `recipients_sendgrid_4.csv` | 216 | 217 | `/home/jc/email-automation/recipients_sendgrid_4.csv` |
| `recipients_sendgrid_5.csv` | 216 | 217 | `/home/jc/email-automation/recipients_sendgrid_5.csv` |

Expected latest confirmed dispatch rows: Private JC 1,788; SendGrid total 1,083; SG1-SG5 217, 217, 217, 216, 216.
