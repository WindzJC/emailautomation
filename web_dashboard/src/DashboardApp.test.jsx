...
describe("DashboardApp", () => {
  ...
  it("consolidates sender operations into overview without duplicate IDs", () => {
    ...
    expect(overview.querySelector("#primary-operation-hero")).not.toBeInTheDocument();
    ...
    expect(overview.querySelector("details.react-sender-detail-disclosure")).not.toBeInTheDocument();
