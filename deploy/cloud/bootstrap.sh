...
install -d -o "${SERVICE_USER}" -g "${SERVICE_GROUP}" -m 0700 "${REPO_ROOT}/.runtime_handoff/import-staging"
install -d -o "${SERVICE_USER}" -g "${SERVICE_GROUP}" -m 0700 "${REPO_ROOT}/.runtime_handoff/receive-transactions"
install -d -o "${SERVICE_USER}" -g "${SERVICE_GROUP}" -m 0700 "${REPO_ROOT}/.runtime_handoff/backups"
